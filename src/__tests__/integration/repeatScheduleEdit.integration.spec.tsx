...
describe('반복 일정 수정 - 통합', () => {
  ...
  it('INT-EDIT-001: 반복 일정 단일 수정 - 해당 일정만 수정되고 반복 아이콘 제거', async () => {
    ...
    // 8. 검증: 1월 3일 일정만 수정되고 나머지 4개 유지
    // 변경된 제목의 일정이 나타났는지 확인
    const changedEvent = await within(monthView).findByText('매일 스탠드업 (변경됨)');
